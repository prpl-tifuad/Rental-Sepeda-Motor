...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2019 at 09:36 AM
...
(6, 'manual', 'bla bla', 'manual', '2019-06-28', '13:15:29', '2019-06-28 13:15:29'),
(7, 'matic', 'motor matic', 'matic', '2019-06-28', '13:16:30', '2019-06-28 13:16:30');
...
(1, 10, 0, '1906289485403', 'aji pamungkas', '0814352425', '12@gmail.com', 'bantul', '2019-06-01', '15:00:00', '2019-06-03', 2, '100000', '', '', 1, '2019-06-28', '2019-06-28 13:54:02');
...
(10, 7, 10, '2019-06-28', '13:48:09', '2019-06-28 13:48:09');
...
(16, 0, 10, '2019-06-28', '13:48:09', '0000-00-00 00:00:00');
...
(4, 'honda crf', 'honda crf . .', 'honda-crf', '2019-06-28', '14:01:32', '2019-06-28 14:01:32');
...
(1, 'Rental Sepeda Motor', 'Akomodasi dengan standar kenyamanan yang memuaskan', '123456789', 'author@mail.com', 'jl. jalan jalan');
...
(10, 'yamaha mio', 'MOTOR MOI', 'yamaha-mio', '50000', 'tg1561704489.png', '2019-06-28', '13:48:09', '2019-06-28 13:48:09');
...
--
ALTER TABLE `bb_invoice`
  MODIFY `id_inv` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `bb_meta_category`
  MODIFY `id_mc` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `bb_meta_seat`
--
ALTER TABLE `bb_meta_seat`
  MODIFY `id_ms` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `bb_vehicle`
  MODIFY `id_vh` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
